...
export class SheetJSApp extends React.Component {
  ...
  exportFile() {
    ...
    console.log("ANTES DE STRINGIFY: ", this.state.data)   //Valida como se ve el objeto antes de aplicar el JSON.strigify
    const datosJSON = JSON.stringify(this.state.data)     //JSON.stringify() convierte un objeto o valor de JavaScript en una cadeta de texto JSON
    console.log("DATOS EN JSON: ", datosJSON);            //Se muestra en consola
